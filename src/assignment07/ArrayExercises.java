...
public class ArrayExercises
{
     ...
     */
    public static void reverseOrder (char[] symbols) // Done
    {
        // Loop through the array, swapping the first element with the last element,
     ...
     */
    public static int count (Object[] values, Object target) // Done
    {
        ...
        try {
            ...
            if (target == null)
            {
                // loop through the array and count the number of nulls
            ...
            {
                // loop through the array and count the number of times the target occurs
                for (int i = 0; i < values.length; i++) {
                    try{
     ...
     */
    public static void replace (String[] list, String original, String replacement) // Done
    {
        try{
            // loop through the array and replace the original with the replacement
     ...
     */
    public static double[] computeAreas (double[] widths, double[] heights) // Done
    {
        // create a new array to store the areas
        double[] areas = new double[widths.length];
        try{
            try{
                // loop through the arrays and compute the area of each rectangle
     ...
     */
    public static Color[] remove (Color[] pixels, Color target) // One Test Failed
    {
        int count = 0;
        ...
        // loop through the array and count the number of elements that are not equal to the target
        ...
        count = 0;
        // loop through the array and add the elements that are not equal to the target to the new array
        for (int i = 0; i < pixels.length; i++) {
            if(pixels[i] != target)
            {
                newPixels[count++] = pixels[i];
            }

        }
        return newPixels;  // Stub
    }
     ...
     */
    public static void sort (int[] data) // Done
    {
        try{
            // loop through the array and sort the elements in descending order
            for (int i = 0; i < data.length; i++) {
                for (int j = 0; j < data.length; j++) {
                    // swap the elements if the first element is less than the second element
                    if(data[i] > data[j])
                    {
                        int temp = data[i];
                        data[i] = data[j];
     ...
     */
    public static Rectangle findSmallest (Rectangle[] rectangles) // Done
    {
        Rectangle smallest = rectangles[0];
        // loop through the array and find the smallest rectangle
        for (int i = 0; i < rectangles.length; i++) {
            try{
                // check if the current rectangle is smaller than the smallest rectangle
                if(rectangles[i].getHeight() * rectangles[i].getWidth() <= smallest.getHeight() * smallest.getWidth())
                {
     ...
     */
    public static int[] histogram (int[] data) // Done
    {
        ...
        // create an array of the size of the maximum value
        int[] counts = new int[maxValue + 1];
        // loop through the array and count the number of times each value appears
        for (int i = 0; i < counts.length; i++) {
            ...
            // add the count to the specific spot in the array
            counts[i] = count;
        }
